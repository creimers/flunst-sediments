...
export default function Home() {
  ...
  // const mudHeight = Math.max(90 - clickCount, 10);
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-gradient-to-b from-amber-700/70 to-amber-950 absolute bottom-0 left-0 z-10 w-screen"
        style={{ height: `${mudHeight}vh` }}
      ></div>
    </div>
  );
}
